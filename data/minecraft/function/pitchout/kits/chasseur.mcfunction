...
execute as @e[type=minecraft:arrow] run execute store result score @s lifeF run data get entity @s life 1

execute as @e[type=arrow,nbt={inGround:1b}] run data merge entity @s {pickup:0b}
execute as @e[type=minecraft:arrow,scores={lifeF=1..799}] run data merge entity @s {life:800s}
...
execute as @a[nbt={SelectedItem:{id:"minecraft:gray_dye"}}] run scoreboard players set @s Cfleche 1
execute as @a[nbt={SelectedItem:{id:"minecraft:red_dye"}}] run scoreboard players set @s Cfleche 2
execute as @a[nbt={SelectedItem:{id:"minecraft:white_dye"}}] run scoreboard players set @s Cfleche 3
execute as @a[nbt={SelectedItem:{id:"minecraft:blue_dye"}}] run scoreboard players set @s Cfleche 4

#-------------------------------------------------------------------------------
#modes arbalete
#mode 1
execute at @a[scores={Cfleche=1}] run execute as @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}},distance=..2,tag=!Ftp,tag=!Ftp2,tag=!Vis,tag=!Bar] run tag @s add mouv
...
execute at @a[scores={Cfleche=2}] run execute as @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}},distance=..2,tag=!Ftp,tag=!Ftp2,tag=!mouv,tag=!Bar] run tag @s add Vis
...
execute at @a[scores={Cfleche=3}] run execute as @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}},distance=..2,tag=!Ftp,tag=!Ftp2,tag=!Vis,tag=!mouv] run tag @s add Bar
...
execute at @a[scores={Cfleche=4,crossbow=1}] run execute as @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}},distance=..2,tag=!mouv,tag=!Ftp2,tag=!Vis,tag=!Bar] run tag @s add Ftp
execute at @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}}] run execute as @a[scores={Cfleche=4,crossbow=1},distance=..2] run scoreboard players set @s crossbow 2

execute at @a[scores={Cfleche=4,crossbow=2..}] run execute as @e[type=minecraft:arrow,nbt={inGround:0b,weapon:{id:"minecraft:crossbow"}},distance=..2,tag=!mouv,tag=!Ftp,tag=!Vis,tag=!Bar] run tag @s add Ftp2
execute as @a[scores={Cfleche=4,crossbow=3}] run scoreboard players set @s crossbow 4



execute if score select map matches 1 run execute if entity @e[type=minecraft:arrow,tag=Ftp] run execute unless entity @e[type=minecraft:arrow,tag=Ftp2] run execute at @e[type=minecraft:arrow,tag=Ftp] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 6.55 12.44 9 60 false @s
execute if score select map matches 1 run execute if entity @e[type=minecraft:arrow,tag=Ftp2] run execute unless entity @e[type=minecraft:arrow,tag=Ftp] run execute at @e[type=minecraft:arrow,tag=Ftp2] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 6.55 12.44 9 55 false @s

execute if score select map matches 2 run execute if entity @e[type=minecraft:arrow,tag=Ftp] run execute unless entity @e[type=minecraft:arrow,tag=Ftp2] run execute at @e[type=minecraft:arrow,tag=Ftp] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 587 96 30 20 false @s
execute if score select map matches 2 run execute if entity @e[type=minecraft:arrow,tag=Ftp2] run execute unless entity @e[type=minecraft:arrow,tag=Ftp] run execute at @e[type=minecraft:arrow,tag=Ftp2] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 587 96 30 20 false @s

execute if score select map matches 3 run execute if entity @e[type=minecraft:arrow,tag=Ftp] run execute unless entity @e[type=minecraft:arrow,tag=Ftp2] run execute at @e[type=minecraft:arrow,tag=Ftp] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 1572 108 10 80 false @s
execute if score select map matches 3 run execute if entity @e[type=minecraft:arrow,tag=Ftp2] run execute unless entity @e[type=minecraft:arrow,tag=Ftp] run execute at @e[type=minecraft:arrow,tag=Ftp2] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 1572 108 10 80 false @s

execute if score select map matches 4 run execute if entity @e[type=minecraft:arrow,tag=Ftp] run execute unless entity @e[type=minecraft:arrow,tag=Ftp2] run execute at @e[type=minecraft:arrow,tag=Ftp] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 465 -297 10 80 false @s
execute if score select map matches 4 run execute if entity @e[type=minecraft:arrow,tag=Ftp2] run execute unless entity @e[type=minecraft:arrow,tag=Ftp] run execute at @e[type=minecraft:arrow,tag=Ftp2] run execute as @a[distance=..1,tag=!antiTP] run spreadplayers 465 -297 10 80 false @s
