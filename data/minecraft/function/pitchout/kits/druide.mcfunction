...
execute at @e[type=minecraft:area_effect_cloud,tag=racines] run tag @e[type=!minecraft:area_effect_cloud,type=!item,distance=..2,tag=!racine,tag=!mort] add slow


execute as @a[scores={racine=1..}] run scoreboard players add @s timeRac 1

execute as @a[scores={racine=1..}] run tag @s add racine
execute at @a[scores={timeRac=1..41}] run particle minecraft:totem_of_undying ~ ~0.4 ~ 0.1 0 0.1 0.1 5 force
execute as @a[scores={racine=1..,timeRac=1..41}] run summon minecraft:area_effect_cloud 289 42 97 {Duration:390,Tags:["racines"]}

execute if score select map matches 1 run execute as @a[scores={racine=1..,timeRac=41}] run spreadplayers 6.55 12.44 9 50 false @e[type=minecraft:area_effect_cloud,tag=racines]
execute if score select map matches 2 run execute as @a[scores={racine=1..,timeRac=41}] run spreadplayers 587 96 5 30 false @e[type=minecraft:area_effect_cloud,tag=racines]
execute if score select map matches 3 run execute as @a[scores={racine=1..,timeRac=41}] run spreadplayers 1572 108 5 45 false @e[type=minecraft:area_effect_cloud,tag=racines]
...
execute as @a[scores={timeRac=500..}] run kill @e[type=minecraft:area_effect_cloud,tag=racines]
...
execute if entity @a[scores={air=1..}] run effect give @a[tag=!air,tag=!mort] minecraft:levitation 6 0 true
