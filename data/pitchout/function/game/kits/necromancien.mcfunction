...
execute as @a[scores={po.cd.fantome=200..,po.use.phantom=1..}] run gamemode adventure
execute as @a[scores={po.cd.fantome=200..,po.use.phantom=1..}] run scoreboard players set @s po.use.phantom 0
execute as @a[scores={po.cd.fantome=200..}] run scoreboard players set @s po.cd.fantome 0
