...
scoreboard players remove @a[scores={po.legacy.detectmort=1..,po.tech.remaining_lives=..5,po.tech.global_timer=1}] po.tech.remaining_lives 1

execute as @a[team=!hub,scores={po.tech.remaining_lives=6}] run scoreboard players set @s po.tech.remaining_lives 5
...
#======================= Téléportation aléatoire sur la map =======================
