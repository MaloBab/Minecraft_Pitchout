...
execute as @a[scores={po.ui.map_menu=2}] store result score @s po.map.v1 run clear @s pitchout:sandstone
...
execute as @a[scores={po.ui.map_menu=2}] store result score @s po.map.v2 run clear @s pitchout:crying_obsidian
...
execute as @a[scores={po.ui.map_menu=2}] store result score @s po.map.v3 run clear @s pitchout:spruce_planks
...
execute as @a[scores={po.ui.map_menu=2}] store result score @s po.map.v4 run clear @s pitchout:copper_grate
...
execute at @a[scores={po.ui.map_menu=2,po.map.res1=0}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 0b,id:"pitchout:sandstone",count:1b,components:{custom_name:'[{"text":"Desert Arena (Moyenne)","color":"gold","bold":true}]'}}
execute at @a[scores={po.ui.map_menu=2,po.map.res2=0}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 9b,id:"pitchout:crying_obsidian",count:1b,components:{custom_name:'[{"text":"Old Gods Mind (Petite)","color":"dark_purple","bold":true}]'}}
execute at @a[scores={po.ui.map_menu=2,po.map.res3=0}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 18b,id:"pitchout:spruce_planks",count:1b,components:{custom_name:'[{"text":"Paradise Garden (Grande)","color":"aqua","bold":true}]'}}
execute at @a[scores={po.ui.map_menu=2,po.map.res4=0}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 2b,id:"pitchout:copper_grate",count:1b,components:{custom_name:'[{"text":"Airship Town (Grande)","color":"red","bold":true}]'}}



execute at @a[scores={po.ui.map_menu=2,po.map.res1=1..}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 0b,id:"pitchout:sandstone",count:1b,components:{custom_name:'[{"text":"Desert Arena (Moyenne)","color":"gold","bold":true}]',enchantments:{levels:{"minecraft:lure":1},show_in_tooltip:false}}}
execute at @a[scores={po.ui.map_menu=2,po.map.res2=1..}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 9b,id:"pitchout:crying_obsidian",count:1b,components:{custom_name:'[{"text":"Old Gods Mind (Petite)","color":"dark_purple","bold":true}]',enchantments:{levels:{"minecraft:lure":1},show_in_tooltip:false}}}
execute at @a[scores={po.ui.map_menu=2,po.map.res3=1..}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 18b,id:"pitchout:spruce_planks",count:1b,components:{custom_name:'[{"text":"Paradise Garden (Grande)","color":"aqua","bold":true}]',enchantments:{levels:{"minecraft:lure":1},show_in_tooltip:false}}}
execute at @a[scores={po.ui.map_menu=2,po.map.res4=1..}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 2b,id:"pitchout:copper_grate",count:1b,components:{custom_name:'[{"text":"Airship Town (Grande)","color":"red","bold":true}]',enchantments:{levels:{"minecraft:lure":1},show_in_tooltip:false}}}
...
execute if score total po.map.res1 matches 0 run execute at @a[scores={po.ui.map_menu=2}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 1b,id:"pitchout:red_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Non-voté","color":"dark_red","bold":true}]'}}
execute if score total po.map.res2 matches 0 run execute at @a[scores={po.ui.map_menu=2}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 10b,id:"pitchout:red_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Non-voté","color":"dark_red","bold":true}]'}}
execute if score total po.map.res3 matches 0 run execute at @a[scores={po.ui.map_menu=2}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 19b,id:"pitchout:red_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Non-voté","color":"dark_red","bold":true}]'}}
execute if score total po.map.res4 matches 0 run execute at @a[scores={po.ui.map_menu=2}] run data modify entity @e[type=chest_minecart,tag=coffremap,limit=1,sort=nearest] Items append value {Slot: 3b,id:"pitchout:red_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Non-voté","color":"dark_red","bold":true}]'}}

execute if score total po.map.res1 matches 1.. run execute as @e[type=chest_minecart,tag=coffremap] run data modify entity @s Items append value {Slot: 1b,id:"pitchout:lime_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Voté","color":"green","bold":true}]'}}
execute if score total po.map.res2 matches 1.. run execute as @e[type=chest_minecart,tag=coffremap] run data modify entity @s Items append value {Slot: 10b,id:"pitchout:lime_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Voté","color":"green","bold":true}]'}}
execute if score total po.map.res3 matches 1.. run execute as @e[type=chest_minecart,tag=coffremap] run data modify entity @s Items append value {Slot: 19b,id:"pitchout:lime_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Voté","color":"green","bold":true}]'}}
execute if score total po.map.res4 matches 1.. run execute as @e[type=chest_minecart,tag=coffremap] run data modify entity @s Items append value {Slot: 3b,id:"pitchout:lime_stained_glass_pane",count:1b,components:{custom_name:'[{"text":"Voté","color":"green","bold":true}]'}}
