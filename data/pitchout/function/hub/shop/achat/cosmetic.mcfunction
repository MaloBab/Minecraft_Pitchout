execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.lasso0 run clear @s pitchout:fishing_rod[pitchout:custom_name='[{"text":"LASSO : ","bold":true,"color":"yellow"},{"text":"DEFAUT","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Cliquez pour sélectionner","color":"green"}]']]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.lasso1 run clear @s pitchout:fishing_rod[pitchout:custom_name='[{"text":"LASSO :","bold":true,"color":"yellow"},{"text":" Modèle 1","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ Cowboy ! ] ","color":"dark_purple"},{"text":"-","bold":true,"color":"red"},{"text":" ","color":"dark_purple"},{"text":"200 ","color":"yellow"},{"text":"po.coins","color":"gold"}]'],pitchout:custom_model_data=1]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.enderpearl0 run clear @s pitchout:ender_pearl[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524c"},{"text":" DEFAUT","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Cliquez pour sélectionner","color":"green"}]']]
...
#ender pearl 1
#po.cos.rangerg pour les possession
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.enderpearl1 run clear @s pitchout:ender_pearl[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524B"},{"text":" Modele 1","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ Teleportation ! ]","color":"dark_purple"},{"text":" ","color":"green"},{"text":"- ","bold":true,"color":"red"},{"text":"150 ","color":"yellow"},{"text":"po.coins","color":"gold"}]'],pitchout:custom_model_data=1]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.enderpearl2 run clear @s pitchout:ender_pearl[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524B"},{"text":" Modele 2","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ In Extremis I ]","color":"dark_purple"},{"text":" ","color":"green"},{"text":"- ","bold":true,"color":"red"},{"text":"250 ","color":"yellow"},{"text":"po.coins","color":"gold"}]'],pitchout:custom_model_data=2]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.enderpearl3 run clear @s pitchout:ender_pearl[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524B"},{"text":" Modele 3","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ In Extremis II ]","color":"dark_purple"},{"text":" ","color":"green"},{"text":"- ","bold":true,"color":"red"},{"text":"350 ","color":"yellow"},{"text":"po.coins","color":"gold"}]'],pitchout:custom_model_data=3]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.model.enderpearl4 run clear @s pitchout:ender_pearl[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524B"},{"text":" Modele 4","bold":true,"color":"dark_blue"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ Du danger ? Quel danger ? II ]","color":"dark_purple"},{"text":" ","color":"green"},{"text":"- ","bold":true,"color":"red"},{"text":"400 ","color":"yellow"},{"text":"po.coins","color":"gold"}]'],pitchout:custom_model_data=4]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.sound.lasso0 run clear @s pitchout:barrier[pitchout:custom_name='[{"text":"LASSO : ","bold":true,"color":"yellow"},{"text":"son par défaut","color":"light_purple"}]']
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.sound.enderpearl0 run clear @s pitchout:barrier[pitchout:custom_name='[{"text":"ENDER PEARL : ","bold":true,"color":"#05524B"},{"text":"son par défaut","color":"light_purple"}]']
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.sound.lasso1 run clear @s pitchout:music_disc_cat[pitchout:custom_name='[{"text":"LASSO : ","bold":true,"color":"yellow"},{"text":"son alternatif 1","color":"light_purple"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ Baroud d\'honneur ] ","color":"dark_purple"},{"text":"-","bold":true,"color":"red"},{"text":" ","color":"dark_purple"},{"text":"150 ","color":"yellow"},{"text":"po.coins","color":"gold"}]']]
...
execute as @a[scores={po.ui.cosmetic_menu=1..}] run execute store success score @s po.sound.enderpearl1 run clear @s pitchout:music_disc_13[pitchout:custom_name='[{"text":"ENDER PEARL :","bold":true,"color":"#05524c"},{"text":" son alternatif 1","color":"light_purple"}]',pitchout:lore=['[{"text":"Prérequis : ","bold":true,"color":"red"},{"text":"[ Du danger ? Quel danger ? I] ","color":"dark_purple"},{"text":"-","bold":true,"color":"red"},{"text":" ","color":"dark_purple"},{"text":"200 ","color":"yellow"},{"text":"po.coins","color":"gold"}]']]
