...
execute as @e[type=trident] store result score @s trident run data get entity @s shake 1

execute as @a[scores={trident=1..}] on vehicle run kill @s[type=trident]
execute as @a[scores={trident=1..}] run scoreboard players set @s trident 0
...
#--------------------------------------------------------------------------------------
#rituel diluvien
execute as @a[scores={deluge=1..}] run scoreboard players add @s deluge 1
execute as @a[scores={deluge=1..3}] run weather rain 25s
execute as @a[scores={deluge=1..279}] run effect give @s speed 1 4 true
execute as @a[scores={deluge=1..279}] run effect give @s glowing 1 4 true
execute as @a[scores={deluge=1..299}] run scoreboard players set @s timeWater 205
execute at @a[scores={deluge=1..299}] run particle falling_water ~ ~ ~ 0.3 1 0.3 0.2 20 force
execute unless entity @a[scores={deluge=1..259}] as @a[scores={deluge=260..}] run weather clear
execute as @a[scores={deluge=300..}] run scoreboard players set @s deluge 0
execute if entity @a[tag=victoire] run scoreboard players set @a deluge 0
#---------------------------------------------------------------------------------------
#maree noire
execute as @a[scores={mareenoire=1..}] run scoreboard players add @s mareenoire 1
execute if entity @a[scores={mareenoire=1..}] at @e[type=area_effect_cloud,tag=water] run particle block{block_state:{Name:obsidian}} ~ ~ ~ 1.5 0.6 1.5 1 20 force
execute as @a[scores={mareenoire=500..}] run scoreboard players set @s mareenoire 0
execute if entity @a[scores={mareenoire=1..}] at @e[type=area_effect_cloud,tag=water] as @a[scores={mareenoire=0},distance=..2.3] run effect give @s nausea 4 1 true
execute if entity @a[scores={mareenoire=1..}] at @e[type=area_effect_cloud,tag=water] as @a[scores={mareenoire=0},distance=..2.3] run effect give @s slowness 1 3 true
execute if entity @a[scores={mareenoire=1..}] at @e[type=area_effect_cloud,tag=water] as @a[scores={mareenoire=0},distance=..2.3] run effect give @s glowing 1 0 true

#----------------------------------------------------------------------
#bouclier
execute at @a[scores={bouclierRep=1..}] run particle dripping_dripstone_water ~ ~ ~ 0.5 2 0.5 1 5 force
execute as @a[scores={bouclierRep=1..}] run scoreboard players add @s bouclierRep 1
execute as @a[scores={bouclierRep=1..}] run attribute @s generic.knockback_resistance base set 0.95
execute as @a[scores={bouclierRep=0}] run attribute @s generic.knockback_resistance base set 0
execute as @a[scores={bouclierRep=1..}] on attacker run effect give @s weakness 1 50 true
execute as @a[scores={bouclierRep=300..}] run scoreboard players set @s bouclierRep 0