...
execute if entity @a[scores={intangibilite=81..}] run execute as @e[tag=inverse] run tag @s remove inverse
execute as @a[scores={intangibilite=81..}] run scoreboard players set @s intangibilite 0