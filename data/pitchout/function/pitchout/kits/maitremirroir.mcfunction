...
#------------------------------------------------------------------
execute as @a[team=GOD,scores={DetectMort=1..,timer=4}] run execute if entity @s[scores={vie=5}] run item replace entity @s hotbar.4 with pitchout:apple[pitchout:lore=['[{"text":"Manger cette ","color":"dark_purple"},{"text":"pomme","color":"red","bold":true},{"text":"","color":"red","bold":false},{"text":" vous permettra de","bold":false},{"text":" lier deux joueurs aléatoires ","bold":false,"color":"aqua"},{"text":"entre eux","bold":false,"color":"dark_purple"}]','[{"text":"pendant ","color":"dark_purple"},{"text":"20 secondes.","color":"gold"}]','[{"text":"Si l\'un meurt, l\'autre mourra aussi ! (Disponible 1 vie sur 2)","color":"light_purple","bold":true}]'],pitchout:attribute_modifiers={modifiers:[],show_in_tooltip:0b},pitchout:enchantments={levels:{"pitchout:aqua_affinity":1},show_in_tooltip:0b},pitchout:custom_name='[{"text":"LIEN DU SANG","bold":true,"color":"dark_red"}]',pitchout:hide_additional_tooltip={},pitchout:dyed_color={rgb:10511680,show_in_tooltip:0b}] 1
...
#-------------------------------------------------------------------
#realite
execute as @a[team=GOD,scores={vie=1}] run item replace entity @s hotbar.7 with pitchout:silence_armor_trim_smithing_template[pitchout:lore=['[{"text":"Lorsque vous consommez cet item,","color":"light_purple"},{"text":" vous réécrivez la réalitée.","color":"gold"}]','[{"text":"TOUS LES JOUEURS","color":"aqua","bold":true},{"text":"","bold":false},{"text":" sevoient attribués une ","bold":false,"color":"gold"},{"text":"classe aléatoire !","color":"dark_purple"}]'],pitchout:attribute_modifiers={modifiers:[],show_in_tooltip:0b},pitchout:enchantments={levels:{"pitchout:aqua_affinity":1},show_in_tooltip:0b},pitchout:custom_name='[{"text":"REALITE ALTEREE","color":"#cc99ff","bold":true},{"text":"","color":"#cc99ff","bold":false}]',pitchout:hide_additional_tooltip={},pitchout:dyed_color={rgb:10511680,show_in_tooltip:0b},pitchout:food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:0.1}] 1
...
#-------------------------------------------------------------------
#contrat
execute if entity @a[scores={contrat=1..}] run clear @a[team=GOD] pitchout:enchanted_book
execute unless entity @a[scores={contrat=1..}] run item replace entity @a[team=GOD,tag=!util,scores={vie=..4}] hotbar.6 with pitchout:enchanted_book[pitchout:lore=['[{"text":"Lorsque vous consommez cet item, vous concluez","color":"light_purple"}]','[{"text":"un pacte avec ","color":"light_purple"},{"text":"un joueur aléatoire. Ce joueur","color":"aqua","bold":true},{"text":" se voit","color":"aqua","bold":false}]','[{"text":"attribuer ","color":"aqua"},{"text":"une cible aléatoire","color":"dark_blue","bold":true},{"text":". Si ","color":"dark_blue","bold":false},{"text":"cette cible meurt","color":"dark_blue","bold":true},{"text":" dans un","color":"dark_blue","bold":false}]','[{"text":"délai de ","color":"dark_blue"},{"text":"30 secondes","color":"dark_red","bold":true},{"text":" alors ","color":"dark_red","bold":false},{"text":"vous perdez une vie et le signataire","color":"red","bold":false}]','[{"text":"du pacte en gagne une.","color":"red"},{"text":" Sinon... C est l inverse !","color":"dark_green"}]','[{"text":"(Utilisabe 1 fois par partie !)","color":"dark_purple","bold":true}]'],pitchout:attribute_modifiers={modifiers:[],show_in_tooltip:0b},pitchout:enchantments={levels:{"pitchout:luck_of_the_sea":1},show_in_tooltip:0b},pitchout:stored_enchantments={levels:{"pitchout:luck_of_the_sea":10},show_in_tooltip:0b},pitchout:custom_name='[{"text":"PACTE INFERNAL","color":"dark_red","bold":true},{"text":"","color":"dark_red","bold":false}]',pitchout:hide_additional_tooltip={},pitchout:dyed_color={rgb:10511680,show_in_tooltip:0b},pitchout:food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:0.1}] 1
...
execute if score time contrat matches 0.. run execute as @a[tag=CibleC,scores={DetectMort=1..}] run execute at @a[scores={contrat=1..}] run summon pitchout:lightning_bolt ~ ~ ~
...
execute if score time contrat matches ..0 run execute at @a[tag=execute] run summon pitchout:lightning_bolt ~ ~ ~
...
execute store result score nbmirroir mirroir run execute if entity @e[type=pitchout:area_effect_cloud,tag=mirroir]
...
execute if score nbGaunter mirroir < nbmirroir mirroir run tag @e[type=pitchout:area_effect_cloud,tag=mirroir,sort=arbitrary,limit=1] add supprMirroir
execute at @e[tag=mirroir,tag=supprMirroir] run fill ~ ~ ~ ~ ~1 ~ air replace pitchout:white_banner
...
execute at @e[type=vex,tag=place] run summon pitchout:area_effect_cloud ~ ~ ~ {Duration:2000000,Tags:["mirroir"]}
execute at @a[scores={mirroir=1..}] run kill @e[type=pitchout:vex,tag=place,limit=1,sort=nearest]
execute as @a[scores={mirroir=1..}] run scoreboard players set @s mirroir 0

execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=0] run data merge entity @s {Rotation:[0f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=1] run data merge entity @s {Rotation:[22.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=2] run data merge entity @s {Rotation:[45f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=3] run data merge entity @s {Rotation:[67.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=4] run data merge entity @s {Rotation:[90f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=5] run data merge entity @s {Rotation:[112.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=6] run data merge entity @s {Rotation:[135f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=7] run data merge entity @s {Rotation:[157.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=8] run data merge entity @s {Rotation:[-180f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=9] run data merge entity @s {Rotation:[-157.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=10] run data merge entity @s {Rotation:[-135f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=11] run data merge entity @s {Rotation:[-112.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=12] run data merge entity @s {Rotation:[-90f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=13] run data merge entity @s {Rotation:[-67.5f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=14] run data merge entity @s {Rotation:[-45f,0f]}
execute as @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute at @s run execute if block ~ ~ ~ pitchout:white_banner[rotation=15] run data merge entity @s {Rotation:[-22.5f,0f]}

execute at @e[type=pitchout:area_effect_cloud,tag=mirroir] run execute as @a[team=GOD,distance=..1,tag=!tpF] run tp @s @e[type=pitchout:area_effect_cloud,tag=mirroir,limit=1,sort=random,distance=2..]
execute at @e[type=pitchout:area_effect_cloud,tag=mirroir] run tp @a[team=GOD,tag=!tpF,distance=..1] ~ ~0.4 ~ ~ ~
execute at @e[type=pitchout:area_effect_cloud,tag=mirroir] run tag @a[team=GOD,tag=!tpF,distance=..1] add tpF
