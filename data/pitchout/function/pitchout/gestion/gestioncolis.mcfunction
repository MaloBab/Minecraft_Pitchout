...
execute as @a[scores={cible=1..}] run data modify entity @e[type=minecraft:area_effect_cloud,tag=Cible,limit=1] Age set value 604
...
execute if score timer timeCible matches 2400 run summon minecraft:area_effect_cloud -8 9 15 {Duration:610,Tags:["Cible"]}
execute if score timer timeCible matches 2401 run spreadplayers 6.55 12.44 10 48 false @e[type=minecraft:area_effect_cloud,tag=Cible,limit=1]
execute if score timer timeCible matches 2402 run execute at @e[type=minecraft:area_effect_cloud,tag=Cible] run tp @e[type=minecraft:area_effect_cloud,tag=Cible] ~ 32 ~
execute if score timer timeCible matches 2403 run execute at @e[type=minecraft:area_effect_cloud,tag=Cible] run setblock ~ ~ ~ minecraft:target
execute if score lifetime timeCible matches 605 run execute at @e[type=minecraft:area_effect_cloud,tag=Cible] run setblock ~ ~ ~ air replace
...
execute as @a[scores={timeCible=1}] run effect give @s minecraft:speed 19 20 true
...
execute as @a[scores={timeCible=2}] run effect give @a[scores={timeCible=0}] minecraft:levitation 15 1 true
...
execute as @a[scores={timeCible=5}] run execute if score epee timeCible matches 75 run execute at @a[tag=damocles] run summon minecraft:lightning_bolt ~ ~ ~
...
execute as @a[scores={timeCible=7}] run effect give @a[scores={timeCible=0}] minecraft:glowing 60 0 true
...
execute as @a[scores={timeCible=8}] run execute if score block timeCible matches 70 run setblock 6 16 12 minecraft:sandstone
execute as @a[scores={timeCible=8}] run execute if score block timeCible matches 71 run tp @a 6 17.2 12
execute as @a[scores={timeCible=8}] run execute if score block timeCible matches 150 run setblock 6 16 12 minecraft:air replace
...
execute as @a[scores={timeCible=9}] run effect give @s minecraft:blindness 6 20 true
execute as @a[scores={timeCible=9}] run effect give @s minecraft:nausea 12 20 true
