...
execute if entity @a[tag=victoire] run data modify entity @e[type=pitchout:area_effect_cloud,tag=Cible,limit=1] Age set value 604
execute if entity @a[tag=victoire] run data modify entity @e[type=pitchout:area_effect_cloud,tag=OTV,limit=1] Age set value 608
execute if entity @a[tag=victoire] run kill @e[type=pitchout:item_frame]
execute if entity @a[tag=victoire] run execute at @e[type=pitchout:area_effect_cloud,tag=mirroir] run fill ~ ~ ~ ~ ~ ~ air replace
execute if entity @a[tag=victoire] run kill @e[type=pitchout:area_effect_cloud,tag=mirroir]
execute if entity @a[tag=victoire] run kill @e[type=pitchout:area_effect_cloud,tag=mine]
execute if entity @a[tag=victoire] run kill @e[type=item]
execute if entity @a[tag=victoire] run execute as @e[type=pitchout:armor_stand,tag=Select] run scoreboard players reset @s plan
...
execute if score timer victoire matches 3 run function pitchout:pitchout/gestion/ajoutvictoire
...
execute if score select map matches 2 run execute if score timer victoire matches 29 run fill 648 37 161 544 84 37 air replace pitchout:water
execute if score select map matches 2 run execute if score timer victoire matches 29 run fill 648 37 161 544 84 37 air replace pitchout:structure_void
...
execute if score timer victoire matches 30 run kill @e[type=!pitchout:player,type=!armor_stand]
...
execute if score timer victoire matches 30 run function pitchout:pitchout/gestion/nettoyage
